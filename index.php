...
<?require_once("inc/header.php");?>
      ...
      for ($x=0; $x<9; $x++)
      {
        ...
        echo "<h4><a href=\"view_tournament.php?id=". $list_of_tournaments[$x][id]. "\">". $list_of_tournaments[$x][Name]." </a></h4>\n";
        echo "<p>Tournament Description:". $list_of_tournaments[$x][Description] ." </p>\n";
        echo "<p><a class='btn' href='register.php?id=". $list_of_tournaments[$x][id]."'>Register &raquo;</a></p>\n";
        echo "</div>\n";
        if ((($x+1)%3)==0) {
          echo "</div> <!--/row-->";
        }
